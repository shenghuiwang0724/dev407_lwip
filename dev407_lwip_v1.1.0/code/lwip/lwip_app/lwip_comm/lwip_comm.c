...
/*LWIP DHCP TASK*/
#define  LWIP_DHCP_TASK_PRIO                           7u   /*TASK PRIORITIES*/
#define  LWIP_DHCP_TASK_STK_SIZE                     128u   /*TASK STACK SIZES*/

static  OS_TCB   LwipDhcpTaskTCB;
static  CPU_STK  LwipDhcpTaskStk[LWIP_DHCP_TASK_STK_SIZE];	   
...
void lwip_comm_dhcp_creat(void)
{
	...
	/* Create lwip_dhcp task */
    OSTaskCreate((OS_TCB       *)&LwipDhcpTaskTCB,
             (CPU_CHAR     *)"Lwip_Dhcp_Task",
             (OS_TASK_PTR   )lwip_dhcp_task,
             (void         *)0u,
             (OS_PRIO       )LWIP_DHCP_TASK_PRIO,
             (CPU_STK      *)&LwipDhcpTaskStk[0u],
             (CPU_STK_SIZE  )LwipDhcpTaskStk[LWIP_DHCP_TASK_STK_SIZE / 10u],
...
void lwip_comm_dhcp_delete(void)
{
	...
	OSTaskDel((OS_TCB *)&LwipDhcpTaskTCB, &err);	//删除DHCP任务
}
